...
from app.safety.models import CommandValidation, RiskLevel, CommandType
...
class SafetyValidator:
    ...
    def get_safe_alternatives(self, command: str) -> List[str]:
        ...
        if re.search(r'firewall-cmd.*--remove', command):
            alternatives.append("Consider using '--add-rich-rule' with reject action instead of removing rules")
