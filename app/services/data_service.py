...
class DataService:
    ...
    def save_report(self, content: str, key: str, data_format: str = "text") -> str:
        """Save generated report.

        Args:
            content: Report content
            key: Key for the report
            data_format: Report format ('text' for MD/HTML)

        Returns:
            Key used for saving
        """
        self.repository.save(key, content, format=data_format)
    ...
    def list_available_data(self) -> Dict[str, List[str]]:
        ...
        categorized = {"collected": [], "explained": [], "reports": [], "other": []}
    ...
    def cleanup_old_data(self, keep_latest: int = 5) -> int:
        ...
        for _, keys in categorized.items():
